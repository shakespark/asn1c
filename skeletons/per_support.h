 ...
 * long form, and uper_put_nsnnwn() refuses to emit anything wider (X.691
 * itself sets no bound). Contracts derived from this capability (e.g. the
 * NativeEnumerated.h unknown-extension reserved region) are cross-checked
 * against it at compile time; see NativeEnumerated.c.
 */
