 ...
 * with OSS Nokalva ASN.1/C 12.0 (TOED) from the same module.
 */
#undef	NDEBUG
#include <stdio.h>
#include <stdlib.h>
...
/*
 * Verify one enumeration value against the OSS golden UPER byte:
...
check_value(const asn_TYPE_descriptor_t *td, long value,
	...
	/* Encode and compare against the OSS golden byte. */
