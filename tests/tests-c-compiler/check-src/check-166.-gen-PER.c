 ...
 * OSS-isomorphic lossless relay), exercised end to end through generated
 ...
 *     same PER transfer syntax, exactly as the OSS ASN.1 tool does.
 * Golden bytes cross-checked against OSS ASN.1 and asn1tools.
 */
#undef	NDEBUG
#include <stdio.h>
#include <stdlib.h>
...
int main() {
	 ...
	 * This is the OSS golden byte (base decodes it to INT_MAX-3 and
